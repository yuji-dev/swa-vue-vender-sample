<template>
  <div id="app">
    <!-- *** 補充員作業：今日の作業-->
    <div v-if="!isSupplied">
      <button class="btn btn-primary" v-on:click="init()">今日の補充をする</button>
    </div>

    <!-- Vender 自動販売機の生成：アサヒ飲料 -->
    <Vender msg="アサヒ飲料 - いらっしゃいませ" ref="refVender_asahi" />

    <!-- Vender 自動販売機の生成：コカコーラ -->
    ...
    return {
      ...
      products: {
        s1: {
          ...
          currentStock: 12,
          hot_or_cool: "hot",
          image: require("./assets/boss_black.png")
        },
        c1: {
          id: 201,
          name: "綾鷹",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/ayataka.png")
        },
        c2: {
          id: 202,
          name: "綾鷹濃い味",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/ayataka_koi.png")
        },
        a1: {
          id: 301,
          name: "三ツ矢サイダー",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/a_mitsuya_cider.png")
        },
        a2: {
          id: 302,
          name: "クリアアサヒ",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/clearasahi.png")
        },
        a3: {
          id: 303,
          name: "ドトールカフェオレ",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/a_doutor_coffee_ore.png")
        },
        a4: {
          id: 304,
          name: "十六茶",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/a_jyuroku_cha.png")
        },
        a5: {
          id: 305,
          name: "ロイヤルミルクティ",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/a_royal_milktea.png")
        },
        a6: {
          id: 306,
          name: "ワンダ極ブラック",
          ...
          currentStock: 10,
          hot_or_cool: "cool",
          image: require("./assets/a_wander_kiwami_black.png")
        }
      }
    };
  },
